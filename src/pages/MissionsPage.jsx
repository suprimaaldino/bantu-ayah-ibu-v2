...
import { Helmet } from 'react-helmet'; // ✅ Tambahkan untuk SEO
...
const MissionsPage = ({ missions, completedMissions, onClaimMission, coins }) => {
  return (
    <>
      ...
      {/* ✅ Gunakan <main> untuk landmark accessibility */}
      <main className="min-h-screen bg-gray-50 pb-20">
        ...
        <div className="p-4">
          <div className="text-center mb-6">
            ...
            {/* ✅ Perbaiki kontras text agar lebih mudah dibaca */}
            <p className="text-gray-700">Bantu Ayah dan Ibu hari ini!</p>
          </div>
